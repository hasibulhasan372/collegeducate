...
const Profile = () => {
    ...
    return (
        <div className="my-con  lg:px-44 py-10 mb-10 lg:mb-20 mx-auto bg-slate-300 mt-7 md:mt-10 lg:mt-20">
            ...
            <h4 className="font-medium text-lg">University: <span className="font-normal text-lg">{myInfo?.university ? myInfo?.university : "Dhaka University" }</span></h4>
            <h4 className="font-medium text-lg">Email: <span className="font-normal text-lg">{myInfo?.userMail}</span></h4>
            <h4 className="font-medium text-lg">Address: <span className="font-normal text-lg">{ myInfo?.address ? myInfo?.address : "Badda, Dhaka"}</span></h4>
            <div className="mt-4">
